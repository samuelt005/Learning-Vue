...
import Recipe from './Recipe-component.vue';
import { sameItems } from '@/utils/lists'
...
export default {
  ...
  async created() {
    ...
    this.receitasEncontradas = receitas.filter((receita) => {
      ...
      const possibleRecipe = sameItems(receita.ingredientes, this.ingredientes);

      return possibleRecipe;
    })
  },
  components: { BotaoPrincipal: MainButton, Recipe: Recipe },
